...
namespace MyFinance.Domain.Entities
{
    public class Transaction
    {
        ...
        public Transaction(Guid userId, DateTime date, TransactionType transactionType, decimal amount, string tipoIngreso, string origenIngreso, string? descripcion = null, string? expenseCategory = null, string nivelNecesidad = "Esencial", string naturalezaGasto = "Consumo", bool esFijo = false)
        {
        ...
        public Transaction(Guid id, Guid userId, DateTime date, TransactionType transactionType, decimal amount, string tipoIngreso, string origenIngreso, string? descripcion = null, string? expenseCategory = null, string nivelNecesidad = "Esencial", string naturalezaGasto = "Consumo", bool esFijo = false)
        {
            if (id == Guid.Empty)
